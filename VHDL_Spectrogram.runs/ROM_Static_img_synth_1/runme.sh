...
HD_PWD='D:/Ing/Master 1sem/Digitale/VHDL_Spectrogram/VHDL_Spectrogram.runs/ROM_Static_img_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROM_Static_img.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROM_Static_img.tcl
