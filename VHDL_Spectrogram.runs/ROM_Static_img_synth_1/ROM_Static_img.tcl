...
set cached_ip [config_ip_cache -export -no_bom  -dir {D:/Ing/Master 1sem/Digitale/VHDL_Spectrogram/VHDL_Spectrogram.runs/ROM_Static_img_synth_1} -new_name ROM_Static_img -ip [get_ips ROM_Static_img]]

if { $cached_ip eq {} } {
close [open __synthesis_is_running__ w]

synth_design -top ROM_Static_img -part xc7z020clg484-1 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix ROM_Static_img_ ROM_Static_img.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ ROM_Static_img_stub.v
 lappend ipCachedFiles ROM_Static_img_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ ROM_Static_img_stub.vhdl
 lappend ipCachedFiles ROM_Static_img_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ ROM_Static_img_sim_netlist.v
 lappend ipCachedFiles ROM_Static_img_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ ROM_Static_img_sim_netlist.vhdl
 lappend ipCachedFiles ROM_Static_img_sim_netlist.vhdl
set TIME_taken [expr [clock seconds] - $TIME_start]

 config_ip_cache -add -dcp ROM_Static_img.dcp -move_files $ipCachedFiles -use_project_ipc  -synth_runtime $TIME_taken  -ip [get_ips ROM_Static_img]
}

rename_ref -prefix_all ROM_Static_img_

# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef ROM_Static_img.dcp
