...
set cached_ip [config_ip_cache -export -no_bom  -dir C:/VHDL_Spectrogram/VHDL_Spectrogram.runs/fft_ip_synth_1 -new_name fft_ip -ip [get_ips fft_ip]]

if { $cached_ip eq {} } {
close [open __synthesis_is_running__ w]

synth_design -top fft_ip -part xc7z020clg484-1 -mode out_of_context
...
set TIME_taken [expr [clock seconds] - $TIME_start]
 ...
 config_ip_cache -add -dcp fft_ip.dcp -move_files $ipCachedFiles -use_project_ipc  -synth_runtime $TIME_taken  -ip [get_ips fft_ip]
}
